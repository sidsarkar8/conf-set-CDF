...
#source("~/Documents/Projects/conf_tail/other_methods/other_methods_bdd.R")
source("/home/siddhaarth/conf_tail/sims_new/other_methods_bdd.R")
#########################
...
parallel_fin_func = function(simul_idx, n2, genCDF_n2)
{
  ...
  CI_and = anderson_CI(x2, alpha, low_bd = lb1, up_bd = ub1)
  CI_cheby  = cheby_CI(x2, alpha, max(ub1^2, lb1^2) )
  CI_emp_bern = emp_bern_CI(x2, alpha, low_bd = lb1, up_bd = ub1)
  CI_hf = hf_CI(x2, alpha, low_bd = lb1, up_bd = ub1)
  CI_PI_emp_bern = PI_emp_bern_CI(x2, alpha, low_bd = lb1, up_bd = ub1)
  CI_hedged = PI_hedged_CI(x2, alpha, low_bd = lb1, up_bd = ub1)
  ...
  qq1 = data.frame(
    ...
    "up_dw_x1_to_xn_tails"    = up_dw_x1_to_xn + up_tail,
    "low_dw_x1_to_xn_tails"   = low_dw_x1_to_xn + low_tail,
    
    "up_t_test"               = CI_t[2],
    "low_t_test"              = CI_t[1],
    
    "up_anderson"             = CI_and[2],
    "low_anderson"            = CI_and[1],
    
    "up_cheby"                = CI_cheby[2],
    "low_cheby"               = CI_cheby[1],
    
    "up_emp_bern"             = CI_emp_bern[2],
    "low_emp_bern"            = CI_emp_bern[1],
    
    "up_hoeffding"            = CI_hf[2],
    "low_hoeffding"           = CI_hf[1],
    
    "up_PI_emp_bern"          = CI_PI_emp_bern[2],
    "low_PI_emp_bern"         = CI_PI_emp_bern[1],
    
    "up_PI_hedged"            = CI_hedged[2],
    "low_PI_hedged"           = CI_hedged[1]
  )
  
  write.csv(qq1,
            file = paste("/home/siddhaarth/conf_tail/sims_new/bdd/indiv_files/bdd_",
...
for( n2_idx in 1:length(n2_seq))
{
  ...
  write.csv(df_n2_bdd,
            file = paste("/home/siddhaarth/conf_tail/sims_new/bdd/bdd_",
