...
fin1 = expand.grid(n = n2_seq, Method = c("CDF", "Wald"),
                   ...
                   Type = c("Bounded", "2-moment", "Sub-G", "|X|log|X|")) 
...
## SUB-G
fin1[1:10 + 40,5] = c(fin_subg[1,] , fin_subg[4,] )   
fin1[11:20 + 40,5] = c(fin_subg[5,], fin_subg[8,])

## xlogx
fin1[1:10 + 60,5] = c(fin_xlogx[1,], fin_xlogx[4,] )    
fin1[11:20 + 60,5] = c(fin_xlogx[5,], fin_xlogx[8,])
